...
def load_audio(fhandle: BinaryIO) -> Tuple[np.ndarray, float]:
    ...
    Args:
        fhandle: path or file-like object pointing to an audio file
...
def load_beats(fhandle: TextIO) -> annotations.BeatData:
    ...
    Args:
        fhandle: path or file-like object pointing to a beat annotation file
...
def load_chords(fhandle: TextIO) -> annotations.ChordData:
    ...
    Args:
        fhandle: path or file-like object pointing to a chord annotation file
...
def load_key(fhandle: TextIO) -> annotations.KeyData:
    ...
    Args:
        fhandle: path or file-like object pointing to a key annotation file
...
def load_sections(fhandle: TextIO) -> annotations.SectionData:
    ...
    Args:
        fhandle: path or file-like object pointing to a section annotation file
