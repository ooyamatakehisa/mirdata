...
def load_audio(fhandle: str) -> Tuple[np.ndarray, float]:
    ...
    Args:
        fhandle: path pointing to an audio file
...
def load_key(fhandle: TextIO) -> str:
    ...
    Args:
        fhandle: File like object or string pointing to key annotation file
...
def load_tempo(fhandle: TextIO) -> str:
    ...
    Args:
        fhandle: File-like object or string pointing to metadata annotation file
...
def load_genre(fhandle: TextIO) -> Dict[str, List[str]]:
    ...
    Args:
        fhandle: File-like object or path pointing to metadata annotation file
