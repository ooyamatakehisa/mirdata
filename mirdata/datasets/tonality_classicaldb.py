...
def load_audio(fhandle: BinaryIO) -> Tuple[np.ndarray, float]:
    ...
    Args:
        fhandle: File-like object or path to audio file
...
def load_key(fhandle: TextIO) -> str:
    ...
    Args:
        fhandle: File-like object or path to key annotation file
...
def load_spectrum(fhandle: TextIO) -> np.ndarray:
    ...
    Args:
        fhandle: File-like object or path to spectrum file
...
def load_hpcp(fhandle: TextIO) -> np.ndarray:
    ...
    Args:
        fhandle: File-like object or path to HPCP file
...
def load_musicbrainz(fhandle: TextIO) -> Dict[Any, Any]:
    ...
    Args:
        fhandle: File-like object or path to musicbrainz metadata file
